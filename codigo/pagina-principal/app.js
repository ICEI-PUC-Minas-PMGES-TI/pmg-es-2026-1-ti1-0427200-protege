...
cardCta.addEventListener('click', () => {
  // Placeholder: navigate to the respective screen
  closeModal(cardModal);
  console.log('Navigating to screen:', cardTitle.textContent);
});
...
saibaMaisCta.addEventListener('click', () => closeModal(saibaMaisOverlay));
